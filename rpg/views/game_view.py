                            ...
                            if item != "Info Paper":
                                ...
                                if self.cur_map_name not in ["leisure2","leisure3","leisure4","farmhouse2"]:
                                    ...
                                    if self.cur_map_name=="leisure2":
                                        self.message_box = MessageBox(self, "Congratulations on passing the first level. \n"
                                        ...
                                        self.message_box = MessageBox(self, "Good job  on jumping those gaps, you almost FELL for it. \n"
                                        ...
                                        self.message_box = MessageBox(self, "Well well well, seems my test subject has surpassed the rest!\n"
                                        ...
                                        self.message_box = MessageBox(self, "Hello sweetheart, you've been sleeping for a while now and I had to go collect \n"
...
# Prueba Tiles de tipo _sonido
    ...
    def on_key_press(self, key, modifiers):
        ...
        if key in constants.CLOSE_MB and (self.cur_map_name in ["leisure2","leisure3","leisure4","farmhouse2"]):
            if self.message_box:
                self.close_message_box()
            else:
                pass
